define("./workbox-4a677df8.js", ["exports"], (function (t) {
    ...
    class v {
        ...
        handleAll(t) {
            ...
            const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request,
                n = "params" in t ? t.params : void 0, r = new R(this, {event: e, request: s, params: n}),
                i = this.v(r, s, e);
    ...
    class A {
        ...
        I(t) {
            this.L(t), this._ && function (t, {blocked: e} = {}) {
        ...
        async getTimestamp(t) {
            const e = await this.getDb(), s = await e.get(S, this.C(t));
        ...
        async getDb() {
            return this.U || (this.U = await function (t, e, {
                blocked: s,
                upgrade: n,
                blocking: r,
                terminated: i
            } = {}) {
                const a = indexedDB.open(t, e), o = T(a);
    ...
    class F {
        constructor(t, e = {}) {
            this.N = !1, this.k = !1, this.O = e.maxEntries, this.T = e.maxAgeSeconds, this.B = e.matchOptions, this._ = t, this.P = new A(t)
        }

        async expireEntries() {
            if (this.N) return void (this.k = !0);
            this.N = !0;
            const t = this.T ? Date.now() - 1e3 * this.T : 0, e = await this.P.expireEntries(t, this.O),
        ...
        install(t) {
            return $(t, (async () => {
                ...
                for (const [e, s] of this.A) {
                    const n = this.H.get(s), r = this.F.get(e),
    ...
    t.CacheFirst = class extends v {
        ...
        constructor(t = {}) {
            ...
            }, this.J = t, this.T = t.maxAgeSeconds, this.X = new Map, t.purgeOnQuotaError && function (t) {
                g.add(t)
