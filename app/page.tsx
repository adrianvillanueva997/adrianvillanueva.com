          ...
          animate-gradient-x"
            ...
            transition-colors duration-200 whitespace-nowrap"
				...
				<div className="prose prose-neutral dark:prose-invert max-w-none space-y-4">
					...
					<p className="text-lg text-neutral-700 dark:text-neutral-300 leading-relaxed">
						I enjoy experimenting with new technologies and finding creative
						ways to combine them to create cool solutions. This is my personal
						space on the internet to share my thoughts and technical writings.
					</p>
				</div>
