...
export function Terminal({
	...
	return (
		<div
			className={`rounded-lg p-4 my-4 font-mono text-sm relative group ${
		...
		>
			...
			{commands.map((cmd) => (
				<div key={cmd.command} className="space-y-1 mb-4">
					...
					{cmd.output && (
						<div
							className={`pl-6 ${cmd.error ? "text-red-400" : "text-gray-400"}`}
						>
							{cmd.output}
						</div>
					)}
