        ...
        <div className="grid md:grid-cols-5 gap-8 items-center">
          <div className="md:col-span-3 space-y-4">
            <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white">
              <span className="text-primary-600 dark:text-primary-400">Hello,</span> I'm {resumeData.personal.name}
            </h1>
            <p className="text-xl text-gray-700 dark:text-gray-300">
              Software Engineer specializing in data engineering, cloud architecture, and systems design. I love solving interesting problems and playing with technology and music.
              <br></br>
              Originally from {resumeData.personal.nationality} but currently based in {resumeData.personal.location}
            </p>
                  ...
                  <div className="h-full p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-100 dark:border-gray-700">
                    <div className="flex flex-col h-full">
                      ...
                      <div className="flex flex-wrap mb-4">
                        {tags.map((tag) => (
                          <span key={tag} className="mr-2 mb-2 px-2 py-1 text-xs rounded-md bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200">
                            {tag}
                          </span>
                        ))}
                      </div>
